...
const translations = {
  zh: {
    ...
    'article.rad_linter_sglang_advantage.section1.subsection1.highlight.content': '医院端涉及ePHI/PHI（受保护健康信息），很多系统默认不能把原始报告、结构化字段、日志、乃至影像相关元数据发到外部云。即使你做脱敏，也常常需要遵循"最小必要原则"：能不外发就不外发。SGLang的本地化特性让Rad-Linter天然满足这些合规要求。',
    ...
    'article.rad_linter_sglang_advantage.section1.subsection2.li2': '<strong>操作系统支持</strong>：Windows、macOS、Linux全平台支持，适配医院现有的IT基础设施',
    ...
    'article.rad_linter_sglang_advantage.section1.subsection3.li1': '<strong>安装简单</strong>：<code>pip install sglang</code> 即可，不需要复杂的依赖管理或环境配置',
  ...
  en: {
    ...
    'article.rad_linter_clinical_qa.subtitle': 'Rad-Linter：为什么临床签发前的跨模态质控是刚需',
    'article.rad_linter_clinical_qa.tags': 'Medical AI · Clinical QA · Healthcare Systems · Regulatory Compliance',
    ...
    'article.rad_linter_sglang_advantage.section1.subsection2.li2': '<strong>Operating System Support</strong>: Full platform support for Windows, macOS, and Linux, adapting to existing hospital IT infrastructure',
    ...
    'article.rad_linter_sglang_advantage.section1.subsection3.li1': '<strong>Simple Installation</strong>: Just <code>pip install sglang</code>, no complex dependency management or environment configuration needed',
